...
#reusing passwords on multiple platforms. Just run the code and sea..lol
#CS-MENT-W (Chem/cyber-Sate-Magnet-Elect-Network-Transport-Wav) #killchain 7
#shorts CS-TL (Chem/Cyber-Sate-Transport-Light) 4
